                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-lg-6">
                            ...
                            <input value="{{old('name',$book->name)}}" type="text" name="name" class="form-control" />
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input value="{{old('release_date',$book->release_date)}}" type="date" name="release_date" class="form-control" />
                        </div>
                        <div class="col-lg-6">
                            <label>التصنيف</label>
                        ...
                        <div class="col-lg-6">
                            <label>السعر </label>
                            <input value="{{old('price',$book->price)}}" type="text" name="price" class="form-control" />
                        </div>
                        <div class="col-lg-6">
                            <label>مرات الشراء </label>
                            <input value="{{old('purchase_number',$book->purchase_number)}}"  type="text" name="purchase_number" class="form-control" />
                        </div>
