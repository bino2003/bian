...
<head>
   ...
   <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets1/img/logo/favicon.png')}}">
   ...
   <link rel="stylesheet" href="{{asset('assets1/css/swiper-bundle.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/slick.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/nouislider.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/backtotop.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/magnific-popup.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/nice-select.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/flaticon_kindedo.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/font-awesome-pro.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/odometer.css')}}">
   <link rel="stylesheet" href="{{asset('assets1/css/spacing.css')}}">
...
<body>
      ...
      <div id="preloader">
         <div class="preloader-thumb-wrap">
            <div class="preloader-thumb">
               ...
               <img src="{{asset('assets1/img/bg/preloader.png')}}" alt="img not found!">
            </div>
         </div>
      </div>
   </div>
                                       ...
                                       <ul>
                                          <li>
                                             <div class="mega-menu-2-inner-thumb p-relative">
                                                <img src="{{asset('assets1/img/logo/mega-menu-1.png')}}" alt="img not found!">
   ...
   <main>
      ...
      <section class="bd-breadcrumb-area p-relative fix theme-bg">
         ...
         <div class="bd-breadcrumb-bg" data-background="{{asset('assets1/img/bg/breadcrumb-bg.jpg')}}"></div>
         <div class="bd-breadcrumb-wrapper mb-60 p-relative">
            <div class="container">
               <div class="bd-breadcrumb-shape d-none d-sm-block p-relative">
                  <div class="bd-breadcrumb-shape-1">
                     <img src="{{asset('assets1/img/shape/curved-line-2.png')}}" alt="img not found!">
                  </div>
                  <div class="bd-breadcrumb-shape-2">
                     <img src="{{asset('assets1/img/shape/white-curved-line.png')}}" alt="img not found!">
                  </div>
               </div>
...
@yield('Content')
    ...
    <section class="bd-newsletter-area">
         <div class="container">
            <div class="bd-newsletter pt-100 pb-100 theme-bg">
               <div class="bd-newsletter-bg" data-background="{{asset('assets1/img/bg/newsletter-bg.jpg')}}"></div>
               <div class="row justify-content-center">
      ...
      <div class="bd-footer-area pt-200">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="bd-footer-widget bd-footer-widget-1 mb-50">
                        <div class="bd-footer-logo mb-35">
                           <a href="index.html"> <img src="{{asset('assets1/img/logo/logo.svg')}}" alt="img not found!"></a>
                        </div>
         ...
         <div class="bd-footer-copyright pb-5">
            <div class="bd-footer-copyright-line pb-20">
               <img src="{{asset('assets1/img/shape/wave-line.png')}}" alt="bottom line">
            </div>
            <div class="container">
   ...
   <!-- JS here -->
   <script src="{{asset('assets1/js/vendor/jquery.js')}}"></script>
   <script src="{{asset('assets1/js/vendor/waypoints.js')}}"></script>
   <script src="{{asset('assets1/js/bootstrap-bundle.js')}}"></script>
   <script src="{{asset('assets1/js/meanmenu.js')}}"></script>
   <script src="{{asset('assets1/js/swiper-bundle.js')}}"></script>
   ...
   <script src="{{asset('assets1/js/parallax.js')}}"></script>
   <script src="{{asset('assets1/js/backtotop.js')}}"></script>
   <script src="{{asset('assets1/js/nice-select.js')}}"></script>
   <script src="{{asset('assets1/js/wow.min.js')}}"></script>
   <script src="{{asset('assets1/js/isotope-pkgd.js')}}"></script>
   <script src="{{asset('assets1/js/imagesloaded-pkgd.js')}}"></script>
   <script src="{{asset('assets1/js/ajax-form.js')}}"></script>
   <script src="{{asset('assets1/js/jquery.appear.js')}}"></script>
   <script src="{{asset('assets1/js/jquery.odometer.min.js')}}"></script>
